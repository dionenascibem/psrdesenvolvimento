...
export const DEFAULT_DATA: DashboardData = {
  produtos: [
    ...
    { nome: "RÓTULO", qtd: 95, valor: 181035.20 },
  ],
  total: { qtd: 458, valor: 1291191.52 },
  financeiro: { faturado: 1202104.52, cancelado: 89087.0 },
  ...
  meta: null,
  devMes: [21, null, 19, 40, 45, 53, 65, 46, 96, 44, 25, 25],
  kpiC: {
    cat: [
  ...
  kpiF: {
    ...
    devReal: [null, null, null, 10878.94, 6556.8, null, null, 748.31, 1308.25, 3983.0, null, null],
    prPrev: [null, null, null, 8810, 8810, 8810, 8810, 8810, 8810, 8810, 8810, 8810],
    prReal: [null, null, null, 11661.23, 7547.49, 12171.25, 7409.0, 15922.05, 3277.4, 7154.0, 8265.0, 4867.0],
  },
};
